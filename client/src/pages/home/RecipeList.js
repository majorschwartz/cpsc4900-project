				...
				({
					...
					>
						<div className="p-6 pt-2">
							{rel === "explore" && (
								<div
									className={`w-full mb-3 text-base flex justify-between items-center`}
								>
									<div>
									...
									{creator_id !== userId && (
										<button
											className="border border-blue-500 text-blue-500 hover:bg-blue-50 px-3 py-[2px] rounded-md z-10"
											onClick={() => {
												handleSaveRecipe();
											}}
										>
